    ...
    public class BaseDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Brand>(a =>
            {
                ...
                a.HasMany(p => p.Models); // Brand'in bir sürü Modeli olabilecegi icin=> HasMany
            });
            ...
            modelBuilder.Entity<Model>(a =>
            {
                ...
                a.HasOne(p => p.Brand); // Bir modelin bir Brand'i olabileceginden => HasOne
            });



            // Seed data - migration yaptigimizda bir iki tane ornek veri kaydedilmesi icin
            
            Brand[] brandEntitySeeds = { new(1, "Mercedes"), new(2, "Golf") };
